...
// flutter pub add carousel_slider (Biblioteca do Fluter Pub Get)
...
void main(List<String> args) {
  runApp(
    MaterialApp(
      debugShowCheckedModeBanner: false, // Remove a listrinha vermelha de debug
      home: MyApp(),
    )
  );
}
...
class MyApp extends StatelessWidget {
          ...
          children: [
            ...
            CarouselSlider(
              options: CarouselOptions(
                ...
                autoPlay: true // Pré-definição de scroll do carrosselo
              ),
            ...
            Expanded(
              child: GridView.builder(
                ...
                // Construtor do grid
                // Construindo usando um foreach // Espaçamento entre linhas
                itemBuilder: (context,index)=> // Arrow function
                GestureDetector(
                  onTap: () => _mostrarImagem (context, imagens[index]), // Método para mostrar a imagem no detalhe
                  child: ClipRRect(borderRadius: BorderRadius.circular(8),
                  child: Image.network(imagens[index],fit: BoxFit.cover,),), // Arredondar os cantos da imagem
                )
              ),
            )
          ],
  ...
  void _mostrarImagem(BuildContext context, String imagen) {
    ...
    showDialog( // showDialog()  -->  Mostrar imagem
